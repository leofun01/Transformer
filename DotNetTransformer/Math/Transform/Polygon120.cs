...
namespace DotNetTransformer.Math.Transform {
	...
	public struct Polygon120 : IFlipRotate<T, P>
	{
		private readonly byte _value;
		private Polygon120(byte value) { _value = value; }
		private Polygon120(int value) { _value = (byte)value; }
		...
		/// </return></summary>
		public bool IsReflection { get { return (_value & 1) == 1; } }
		/// <summary><return>
		/// <para>true for rotations;</para>
		/// <para>false for reflections (flip + rotation).</para>
		/// </return></summary>
		public bool IsRotation { get { return (_value & 1) == 0; } }

		P IFlipRotate<T, P>.Permutation {
			get { return new P((byte)((_value & 1) * 5)); }
		}
		public int Vertex { get { return _value >> 1; } }
		...
		public int CycleLength {
			get {
				...
				/*/
				int r = _mod;
				if(_value % 0x06 == 0) r &= 0x28;
				if(_value % 0x0A == 0) r &= 0x18;
				if((_value & 0x02) == 0) r >>= 1;
				if((_value & 0x06) == 0) r >>= 1;
				if((_value & 0x0E) == 0) r >>= 1;
				return r;
				//*/
			}
		}
		public T InverseElement {
			get {
				if(IsReflection || _value == 0) return this;
				return new T(_count - _value);
			}
		}
		public T Add(T other) {
			int o = (other._value & -2), f = (_value ^ other._value) & 1;
			if(IsReflection) o = _count - o;
			return new T(((_value & -2) + o) % _count ^ f);
		}
		...
		public T Times(int count) {
			if(IsReflection) return new T((count & 1) * _value);
			return new T((count % _mod + _mod) * _value % _count);
		}
